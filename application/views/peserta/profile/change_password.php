  ...
  <div class="row">
    <div class="col-lg-7 mx-auto">
      <div class="card shadow-lg">
        ...
        <div class="row">
          <div class="col-lg-8 ">
            <form action="<?= base_url('peserta/profile/update-password'); ?>" method="post">
              <div class="card-body ml-5">
                ...
                <div class="form-group">
                  ...
                  <a class="btn btn-primary mt-3 mb-3" href="<?= base_url('peserta/dashboard') ?>" role="button">Kembali</a>
                </div>
              </div>
            </form>
          </div>
