          ...
          ?>
            <tr>
                ...
                <td width="120px">
                  ...
                  <a class="btn btn-sm btn-warning" href="<?=base_url('admin/peserta/edit/'.$id_encryption)?>" title="Ubah">
                    <i class="fas fa-edit"></i>
                  </a>
                  <button href="" onclick="deleteConfirm('<?=base_url('admin/peserta/delete/'.$id_encryption)?>')" class="btn btn-sm btn-danger" title="Hapus" data-target="#modalDelete" data-toggle="modal">
