 ...
 <ul class="navbar-nav  sidebar sidebar-dark accordion" id="accordionSidebar" style="background-color: #003b46">
   ...
   <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
     <img class="sidebar-brand-icon " src="<?= base_url('assets/img/atensi.png'); ?>" width="50" height="50">
   ...
   <li class="nav-item">
     <a class="nav-link" href="<?= base_url('admin/daftarnama'); ?>">
       <!-- icon -->
       <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-card-list" viewBox="0 0 16 16">
         <path d="M14.5 3a.5.5 0 0 1 .5.5v9a.5.5 0 0 1-.5.5h-13a.5.5 0 0 1-.5-.5v-9a.5.5 0 0 1 .5-.5h13zm-13-1A1.5 1.5 0 0 0 0 3.5v9A1.5 1.5 0 0 0 1.5 14h13a1.5 1.5 0 0 0 1.5-1.5v-9A1.5 1.5 0 0 0 14.5 2h-13z" />
         <path d="M5 8a.5.5 0 0 1 .5-.5h7a.5.5 0 0 1 0 1h-7A.5.5 0 0 1 5 8zm0-2.5a.5.5 0 0 1 .5-.5h7a.5.5 0 0 1 0 1h-7a.5.5 0 0 1-.5-.5zm0 5a.5.5 0 0 1 .5-.5h7a.5.5 0 0 1 0 1h-7a.5.5 0 0 1-.5-.5zm-1-5a.5.5 0 1 1-1 0 .5.5 0 0 1 1 0zM4 8a.5.5 0 1 1-1 0 .5.5 0 0 1 1 0zm0 2.5a.5.5 0 1 1-1 0 .5.5 0 0 1 1 0z" />
       </svg>
       <span>Daftar Nama</span></a>
   </li>

   <li class="nav-item">
     <a class="nav-link" href="<?= base_url('admin/jprogram'); ?>">
   ...
   <li class="nav-item">
     <a class="nav-link" href="#">
       ...
       <span>Progres Rehabilitasi</span></a>
   </li>

   <li class="nav-item">
     <a class="nav-link collapsed" href="<?= base_url('admin/laporan'); ?>" data-toggle="collapse" data-target="#collapseUtilities" aria-expanded="true" aria-controls="collapseUtilities">
     ...
     <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
       <div class="bg-white py-2 collapse-inner rounded">
         ...
         <a class="collapse-item" target="_blank" href="<?= base_url('admin/pdf1'); ?>">Daftar Nama</a>
         <a class="collapse-item" target="_blank" href="<?= base_url('admin/printprogram'); ?>">Progres Rehabilitasi</a>
       </div>
     </div>
   </li>
